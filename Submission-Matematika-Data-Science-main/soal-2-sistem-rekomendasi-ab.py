# -*- coding: utf-8 -*-
"""Copy of soal-2-sistem-rekomendasi-ab.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1VjEzDZwGMhU3HqKda3nMPmKL2AGMEDs3
...
def t_statistics_form(origin_metrics, varian_metrics):
    ...
    t = ((xbar1 - xbar2) - 0) / np.sqrt((s1 ** 2 / n1) + (s2 ** 2 / n2))
    # AKHIRI KODE DI SINI
