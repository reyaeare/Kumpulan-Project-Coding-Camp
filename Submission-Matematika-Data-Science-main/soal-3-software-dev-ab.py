# -*- coding: utf-8 -*-
"""Copy of soal-3-software-dev-ab.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1lpHLXcTLx5tTrlQ9v1JL93LgnsUrOMSI
...
def estimate_sample_size_proportions(p1, p2, alpha=0.05, beta=0.20, two_sided=True):
    ...
    n = ((np.sqrt(p_bar * q_bar * (1 + 1 / k)) * z_alpha + np.sqrt(p1 * q1 + (p2 * q2 / k)) * z_beta) ** 2) / (delta ** 2)
    # AKHIRI KODE DI SINI
...
n_days = math.ceil((2 * sample_size_needed) / active_users_per_day) # Isi dengan perhitungan Anda
# AKHIRI KODE DI SINI
